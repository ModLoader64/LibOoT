...
namespace OoT.API {
    ...
    public class WrapperSaveContext {
        ...
        public u8 isDoubleDefenseAcquired {get => this._isDoubleDefenseAcquired(); set => this._isDoubleDefenseAcquired(value);}//;
        ...
        // #ARRCOUNT 6
        private @char[] _newf() {
            @char[] bytes = new @char[6]; for(u32 i = 0; i < 6; i++){bytes[i] = Memory.RAM.ReadU8(this.pointer + 0x001C + (i * 1));} return bytes;
        }
        ...
        private @char[] _playerName() {
            @char[] bytes = new @char[8]; for(u32 i = 0; i < 8; i++){bytes[i] = Memory.RAM.ReadU8(this.pointer + 0x0024 + (i * 1));} return bytes;
        }
        ...
        private @char[] _unk_3B() {
            @char[] bytes = new @char[0x01]; for(u32 i = 0; i < 0x01; i++){bytes[i] = Memory.RAM.ReadU8(this.pointer + 0x003B + (i * 1));} return bytes;
        }
        ...
        private u8 _isDoubleDefenseAcquired() {
            return Memory.RAM.ReadU8(this.pointer + 0x003D);
        }
        
        private void _isDoubleDefenseAcquired(u8 value) {
            Memory.RAM.WriteU8(this.pointer + 0x003D, value);
        }
        ...
        private @char[] _unk_58() {
            @char[] bytes = new @char[0x0E]; for(u32 i = 0; i < 0x0E; i++){bytes[i] = Memory.RAM.ReadU8(this.pointer + 0x0058 + (i * 1));} return bytes;
        }
        ...
        private @char[] _unk_E8C() {
            @char[] bytes = new @char[0x10]; for(u32 i = 0; i < 0x10; i++){bytes[i] = Memory.RAM.ReadU8(this.pointer + 0x0E8C + (i * 1));} return bytes;
        }
        ...
        private s32[] _gsFlags() {
            s32[] bytes = new s32[6]; for(u32 i = 0; i < 6; i++){bytes[i] = Memory.RAM.ReadS32(this.pointer + 0x0E9C + (i * 4));} return bytes;
        }
        ...
        private @char[] _unk_EB4() {
            @char[] bytes = new @char[0x4]; for(u32 i = 0; i < 0x4; i++){bytes[i] = Memory.RAM.ReadU8(this.pointer + 0x0EB4 + (i * 1));} return bytes;
        }
        ...
        private s32[] _highScores() {
            s32[] bytes = new s32[7]; for(u32 i = 0; i < 7; i++){bytes[i] = Memory.RAM.ReadS32(this.pointer + 0x0EB8 + (i * 4));} return bytes;
        }
        ...
        private u16[] _eventChkInf() {
            u16[] bytes = new u16[14]; for(u32 i = 0; i < 14; i++){bytes[i] = Memory.RAM.ReadU16(this.pointer + 0x0ED4 + (i * 2));} return bytes;
        }
        ...
        private u16[] _itemGetInf() {
            u16[] bytes = new u16[4]; for(u32 i = 0; i < 4; i++){bytes[i] = Memory.RAM.ReadU16(this.pointer + 0x0EF0 + (i * 2));} return bytes;
        }
        ...
        private u16[] _infTable() {
            u16[] bytes = new u16[30]; for(u32 i = 0; i < 30; i++){bytes[i] = Memory.RAM.ReadU16(this.pointer + 0x0EF8 + (i * 2));} return bytes;
        }
        ...
        private @char[] _unk_F34() {
            @char[] bytes = new @char[0x04]; for(u32 i = 0; i < 0x04; i++){bytes[i] = Memory.RAM.ReadU8(this.pointer + 0x0F34 + (i * 1));} return bytes;
        }
        ...
        private @char[] _unk_F3C() {
            @char[] bytes = new @char[0x4]; for(u32 i = 0; i < 0x4; i++){bytes[i] = Memory.RAM.ReadU8(this.pointer + 0x0F3C + (i * 1));} return bytes;
        }
        ...
        private u8[] _scarecrowLongSong() {
            u8[] bytes = new u8[0x360]; for(u32 i = 0; i < 0x360; i++){bytes[i] = Memory.RAM.ReadU8(this.pointer + 0x0F41 + (i * 1));} return bytes;
        }
        ...
        private @char[] _unk_12A1() {
            @char[] bytes = new @char[0x24]; for(u32 i = 0; i < 0x24; i++){bytes[i] = Memory.RAM.ReadU8(this.pointer + 0x12A1 + (i * 1));} return bytes;
        }
        ...
        private u8[] _scarecrowSpawnSong() {
            u8[] bytes = new u8[0x80]; for(u32 i = 0; i < 0x80; i++){bytes[i] = Memory.RAM.ReadU8(this.pointer + 0x12C6 + (i * 1));} return bytes;
        }
        ...
        private @char[] _unk_1346() {
            @char[] bytes = new @char[0x02]; for(u32 i = 0; i < 0x02; i++){bytes[i] = Memory.RAM.ReadU8(this.pointer + 0x1346 + (i * 1));} return bytes;
        }
        ...
        private @char[] _unk_1358() {
            @char[] bytes = new @char[0x0004]; for(u32 i = 0; i < 0x0004; i++){bytes[i] = Memory.RAM.ReadU8(this.pointer + 0x1358 + (i * 1));} return bytes;
        }
        ...
        private @char[] _unk_13C2() {
            @char[] bytes = new @char[0x0001]; for(u32 i = 0; i < 0x0001; i++){bytes[i] = Memory.RAM.ReadU8(this.pointer + 0x13C2 + (i * 1));} return bytes;
        }
        ...
        private @char[] _unk_13CA() {
            @char[] bytes = new @char[0x0002]; for(u32 i = 0; i < 0x0002; i++){bytes[i] = Memory.RAM.ReadU8(this.pointer + 0x13CA + (i * 1));} return bytes;
        }
        ...
        private s16[] _timerX() {
            s16[] bytes = new s16[(int)TimerId.TIMER_ID_MAX]; for(u32 i = 0; i < (int)TimerId.TIMER_ID_MAX; i++){bytes[i] = Memory.RAM.ReadS16(this.pointer + 0x13D6 + (i * 2));} return bytes;
        }
        ...
        // #ARRCOUNT (int)TimerId.TIMER_ID_MAX
        private s16[] _timerY() {
            s16[] bytes = new s16[(int)TimerId.TIMER_ID_MAX]; for(u32 i = 0; i < (int)TimerId.TIMER_ID_MAX; i++){bytes[i] = Memory.RAM.ReadS16(this.pointer + 0x13DA + (i * 2));} return bytes;
        }
        ...
        private @char[] _unk_13DE() {
            @char[] bytes = new @char[0x0002]; for(u32 i = 0; i < 0x0002; i++){bytes[i] = Memory.RAM.ReadU8(this.pointer + 0x13DE + (i * 1));} return bytes;
        }
        ...
        private u8[] _buttonStatus() {
            u8[] bytes = new u8[5]; for(u32 i = 0; i < 5; i++){bytes[i] = Memory.RAM.ReadU8(this.pointer + 0x13E2 + (i * 1));} return bytes;
        }
        ...
        private u16[] _eventInf() {
            u16[] bytes = new u16[4]; for(u32 i = 0; i < 4; i++){bytes[i] = Memory.RAM.ReadU16(this.pointer + 0x13FA + (i * 2));} return bytes;
        }
        ...
        private @char[] _unk_1408() {
            @char[] bytes = new @char[0x0001]; for(u32 i = 0; i < 0x0001; i++){bytes[i] = Memory.RAM.ReadU8(this.pointer + 0x1408 + (i * 1));} return bytes;
        }
        ...
        private @char[] _unk_140B() {
            @char[] bytes = new @char[0x0001]; for(u32 i = 0; i < 0x0001; i++){bytes[i] = Memory.RAM.ReadU8(this.pointer + 0x140B + (i * 1));} return bytes;
        }
        ...
        private @char[] _unk_1411() {
            @char[] bytes = new @char[0x0001]; for(u32 i = 0; i < 0x0001; i++){bytes[i] = Memory.RAM.ReadU8(this.pointer + 0x1411 + (i * 1));} return bytes;
        }
        ...
        private @char[] _unk_141E() {
            @char[] bytes = new @char[0x0002]; for(u32 i = 0; i < 0x0002; i++){bytes[i] = Memory.RAM.ReadU8(this.pointer + 0x141E + (i * 1));} return bytes;
        }
